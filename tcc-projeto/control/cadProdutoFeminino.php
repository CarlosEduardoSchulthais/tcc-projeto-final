<?php
    ...
    if(empty($msgErro)){
        if(empty($id) | $id === null || $id === ''){
            ...
            header("Location:../view/cadastroProdutoFeminino.php?msg=Produto inserido com sucesso.");
        } else{
            alterarProduto($referencia, $nome, $preco, $descricao, $qtdestoque, $foto, $modelo, $coresSelecionadas, $tamanhosSelecionados, $id);
            header("Location:../view/cadastroProdutoFeminino.php?msg=Produto alterado com sucesso.");
        }
    } else{
        header("Location:../view/cadastroProdutoFeminino.php?msg=$msgErro");
    }
