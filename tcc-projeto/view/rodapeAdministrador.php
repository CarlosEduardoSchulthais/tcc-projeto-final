<div class="row" style="background-color: #808080; height: 330px">
    <div class="col" style="margin: 30px">
        ...
        <br>
        <a href="minhaContaAdministrador.php" style="font-size: 20px; text-decoration: none; color: black">Minha conta</a>
        <br>
        <a href="aprovarVendas.php" style="font-size: 20px; text-decoration: none; color: black">Aprovar vendas</a>
    </div>
    <div class="col" style="margin: 30px">
