...
<body style="margin: 0;
    ...
    overflow-x: hidden;">
        ...
        <div style="background-color: #DCDCDC">
            ...
            <br>
            <div class="row" style="display: flex; justify-content: center">
                <a href="pagina-feminino.php" class="btn btn-success" style="width: 20%">VER DETALHES →</a>
            </div>
            <br>
            <br>
        </div>
        <div style="background-color: #A9A9A9">
            ...
            <br>
            <div class="row" style="display: flex; justify-content: center">
                <a href="pagina-masculino.php" class="btn btn-success" style="width: 20%">VER DETALHES →</a>
            </div>
            <br>
            <br>
        </div>
